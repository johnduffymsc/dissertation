...
The original system of linear equations can then be restated as:
...
By what ``Trefethen and Bau'' refer to as a third \emph{Stroke of Luck}, (3.10) can be restated as:
...
TODO CITE: "HPL Algorithm" document on NetLib

...
The format of \verb|hpcg.dat| is as follows:
...
Lines 1 and 2 are comments, line 3 specifies the 3 dimensions of the problem size, and line 4 specifies the run time in seconds. For benchmark runs to be submitted for official performance ranking the run time must exceed 30 minutes (1800 seconds).
...
The June 2020 HPCG List ranks 169 computer systems in order of conjugate gradient performance. Ranking number 1 is the Fugaku supercomputer, with the Spaceborne Computer, onboard the International Space Station, ranking number 169:
...
The Spaceborne Computer is a 32 core system based on the Intel Xeon E5-2620 v4 8 Core CPU, clocked at 2.1GHz, with an Infiniband interconnect.

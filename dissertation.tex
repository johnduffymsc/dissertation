...
For the High Performance Linpack benchmark, to achieve 100\% performance requires a problem size that uses 100\% of memory. Because the operating system requires some memory, is it not possible to allocate 100\% memory for benchmarks.

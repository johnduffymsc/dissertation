...
\begin{figure}
	...
	\caption{dgemm \emph{kernel} Matrix-Matrix Multiplication.}
	\label{fig:image2}
\end{figure}
...
The same number of nodes, slots and work processes to run is specified using the \verb|-hostfile| parameter as follows:

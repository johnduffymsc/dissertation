...
\begin{itemize}
  ...
  \item 1 x 8 Port Gigabit Router/Firewall
  \item 1 x 16 Port Gigabit Switch with Jumbo Frame support
...
Some benchmarks take a substantial amount of time to run, so it is helpful to have a dedicated build node for compiling software, developing scripts, etc, whilst the benchmarks run on dedicated compute nodes.

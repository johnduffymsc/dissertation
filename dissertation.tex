...
MicroSD cards are available in a number of speed classes and use categories. The recommended minimum specification for the Raspberry Pi 4 is Class 10 A1. The ``10'' refers to a 10 MB/s write speed. The ``A'' refers to the ``Application'' category, which support at least 1500 read operations and 500 write operations per second.

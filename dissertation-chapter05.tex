...
The kernel installed by Ubuntu 20.04 LTS 64-bit uses the Voluntary Preemption model. To use the No Forced Preemption model the Linux kernel must be recompiled. Detailed instructions on how to do this are included in the \emph{Kernel Build With No Forced Preemption} \verb|picluster| repository wiki page.

The Pi Cluster Tools \verb|linpack-profiler| tool was run with a No Forced Preemption kernel. The results are plotted in Figure ??.

\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{profile_nopreempt_8_node_20_percent_memory.pdf}
	\caption{Pi Cluster Tools \texttt{linpack-profiler} results plotted for a No Forced Preemption kernel. The tool uses all 8 nodes and 20\% of available memory.}
	\label{fig:subim1}
\end{figure}
...
\textbf{BLAS} & \textbf{N} & \textbf{NB} & \textbf{P} & \textbf{Q} & \textbf{Baseline}  & \textbf{No Forced}  \\
              &            &             &            &            &                    & \textbf{Preemption} \\
\hline
OpenBLAS Serial & 52320 & 120 & 1 & 32 & 8.6787e+01 & 8.5741e+01 \\
Serial          & 52320 & 120 & 2 & 16 & 9.5517e+01 & 9.2858e+01 \\
                & 52320 & 120 & 4 &  8 & 9.5525e+01 & 9.3784e+01 \\
\hline
OpenBLAS OpenMP & 52360 &  88 & 1 &  8 & 8.8626e+01 & 8.6306e+01 \\
                & 52360 &  88 & 2 &  4 & 9.6630e+01 & 9.4254e+01 \\
\hline
BLIS Serial     & 52416 & 168 & 1 & 32 & 9.1148e+01 & 8.9747e+01 \\
                & 52416 & 168 & 2 & 16 & 1.0341e+02 & 1.0114e+02 \\
                & 52416 & 168 & 4 &  8 & 1.0190e+02 & 1.0183e+02 \\
\hline
BLIS OpenMP     & 52400 & 200 & 1 &  8 & 9.1180e+01 & 7.4336e+01 \\
                & 52400 & 200 & 2 &  4 & 1.0041e+02 & 7.8256e+01 \\
\hline
\end{tabular}
\end{center}
\caption{\label{tab:table-name}Comparison of the Baseline HPL $R_{max}$ with a No Forced Preemption kernel.}
\end{table}

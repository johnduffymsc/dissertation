...
\begin{figure}[]
	...
	\begin{subfigure}{1.0\textwidth}
		...
		\caption{Aerin Cluster Running Benchmark}
		\label{fig:subim2}
	\end{subfigure}
\caption{\textbf{Aerin Cluster Power Usage.} Similar power usage was observed running either pure OpenMPI or hybrid OpenMPI/OpenMP benchmarks.}
\label{fig:image2}
\end{figure}

...
The BCM2711 Arm Cortex-A72 contains the following L1 caches, each with 64 byte cache lines:
\begin{itemize}
\item 48KB 3-way set-associative instruction cache
\item 32KB 2-way set-associative data cache
\end{itemize}

The BCM2711 Arm Cortex-A72 contains the following L2 caches, each with 64 byte cache lines:
\begin{itemize}
\item 1MB 16-way set-associative unified cache
\end{itemize}

The MMU for the BCM2711 Arm Cortex-A72 contains the following caches:
\begin{itemize}
